              ...
              <div className="space-y-3 animate-fade-in">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 text-center text-lg font-mono border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
